...
(function() {
  ...
  function handleScroll() {
    ...
    // Hero video parallax effect - moves up as you scroll
    if (heroVideo && currentScrollY <= heroHeight) {
    ...
    if (heroContent && currentScrollY <= heroHeight) {
      const opacity = 1 - (currentScrollY / (heroHeight * 0.5));
